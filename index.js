...
function goLeft(){
    ...
    Do you follow it, or leave and continue on your path?`)
...
function Continue(){
    let fourthAnswer = window.prompt(`You come across a chamber that extends upward to a shining light above.
    There is a long, winding staircase and a much quicker,but rickety-looking, ladder that lead up towards the light. Which do you take?`)
...
function awayFromTheDragon(){
    let fourthAnswer = window.prompt(`After walking a while longer, you come across a shiny blue flower.
